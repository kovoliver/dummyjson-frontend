...
export default function ConfirmationProvider({ children }: { children: ReactNode }) {
    ...
    const [messageType, setMessageType] = useState<ThemeColorType>("warning");
    const [isVisible, setIsVisible] = useState<boolean>(false);

    const [confirmText, setConfirmText] = useState<string>("OK");
    const [cancelText, setCancelText] = useState<string>("Mégse");
    const [confirmVariant, setConfirmVariant] = useState<ThemeColorType>("main");
    const [cancelVariant, setCancelVariant] = useState<ThemeColorType>("secondary");
